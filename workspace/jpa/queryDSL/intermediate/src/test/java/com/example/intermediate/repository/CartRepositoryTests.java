...
//        Optional<Product> foundProduct = productRepository.findById(101L);
//        Optional<Cart> foundCart = cartRepository.findById(102L);
//        foundCart.ifPresent(cart ->
//                foundProduct.ifPresent(product -> product.setProductStock(product.getProductStock() + cart.getCount().intValue())));
//
